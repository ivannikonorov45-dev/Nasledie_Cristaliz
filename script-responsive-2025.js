...
async function savePet(){
    ...
    if (petId) {
        ...
        // Автоматическая синхронизация отключена для предотвращения потери данных
        // Пользователь может использовать кнопку "Синхронизировать" если нужно синхронизировать вручную
        console.log('💡 Для синхронизации нажмите кнопку "Синхронизировать"');
